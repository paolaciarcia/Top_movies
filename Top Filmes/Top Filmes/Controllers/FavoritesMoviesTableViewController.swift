...
class FavoritesMoviesTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "\(FavoriteCell.self)", for: indexPath) as? FavoriteCell else { fatalError("Could not create RecipeCell") }
